import PersonaConflict from '@hiram-labs/lrs-persona-service/dist/errors/Conflict';
import PersonaNoModelWithId from '@hiram-labs/lrs-persona-service/dist/errors/NoModelWithId';
import PersonaHasIdentsError from '@hiram-labs/lrs-persona-service/dist/errors/PersonaHasIdentsError';
import NoModel from '@hiram-labs/lrs-js-common/dist/errors/NoModel';
import defaultTo from 'lodash/defaultTo';
import { v4 as uuid } from 'uuid';
import { Warnings, Warning } from '@hiram-labs/lrs-js-common/dist/warnings';
...
const handleRequestError = (res, err) => {
  ...
  if (err instanceof NoAccessError || err instanceof UnauthorisedQueryError) {
  ...
  if (err instanceof RequestAppAccessError) {
