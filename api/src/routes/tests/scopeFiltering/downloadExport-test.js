...
import { VIEW_PUBLIC_DOWNLOADS, VIEW_ALL_DOWNLOADS } from 'lib/constants/orgScopes';
...
describe('DownloadController.downloadExport scope filtering', () => {
  ...
  const downloadExport = async ({ expectedCode, token, ownerId = TEST_ID, orgId = TEST_ID, isPublic = false }) => {
