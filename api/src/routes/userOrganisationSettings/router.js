...
const canCreateOrgSettings = (req) => matchesTargetOrgAndTokenOrg(req) && hasValidScope(req);

const canUpdateOrgSettings = (req) =>
  matchesTargetOrgAndTokenOrg(req) && (hasValidScope(req) || isUpdatingOwnOrgSettings(req));

const canDeleteOrgSettings = (req) => matchesTargetOrgAndTokenOrg(req) && hasValidScope(req);
