 ...
 */
const adminModelFilter =
  ({ viewAllScopes, editAllScopes }) =>
...
const getAdminModelFilter = (scopeConstants) =>
  getModelsFilter({
    ...scopeConstants,
    filters: [getSiteAdminFilter, checkAllowedTokenType, checkAllScope, adminModelFilter]
  });
