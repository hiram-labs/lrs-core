...
import getOrganisationScopeFilter from 'lib/services/auth/modelFilters/organisation';
import getPersonaScopeFilter from 'lib/services/auth/modelFilters/persona';
import getBatchDeleteScopeFilter from 'lib/services/auth/modelFilters/batchDelete';
...
import getVisualisationScopeFilter from 'lib/services/auth/modelFilters/visualisation';
import getStatementForwardingScopeFilter from 'lib/services/auth/modelFilters/statementForwarding';
...
export default async (opts) => {
  switch (opts.modelName.toLowerCase()) {
    ...
    case 'batchdelete':
      return getBatchDeleteScopeFilter(opts);
    case 'sitesettings':
      return {};
    default:
