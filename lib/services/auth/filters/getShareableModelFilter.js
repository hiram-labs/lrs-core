...
export const shareableModelFilter =
  ({ viewAllScopes, viewPublicScopes, editAllScopes, editPublicScopes }) =>
...
export const filters = [getSiteAdminFilter, checkAllowedTokenType, checkAllScope, shareableModelFilter];
