...
import { TEST_ORG_FILTER, TEST_PRIVATE_FILTER, TEST_PUBLIC_FILTER } from 'lib/services/auth/tests/utils/constants';

export default ({ modelName, viewAllScopes, viewPublicScopes, editAllScopes, editPublicScopes }) => {
