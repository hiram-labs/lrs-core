import { SITE_ADMIN, ALL, XAPI_ALL, XAPI_STATEMENTS_WRITE, XAPI_STATEMENTS_DELETE } from 'lib/constants/scopes';
import { MANAGE_ALL_USERS } from 'lib/constants/orgScopes';
import setup from 'lib/services/auth/tests/utils/setup';
import testOrgScopeFilter from 'lib/services/auth/tests/utils/testOrgScopeFilter';
import testOrgScopeFilterError from 'lib/services/auth/tests/utils/testOrgScopeFilterError';
import testOrgScopeFilterOwner from 'lib/services/auth/tests/utils/testOrgScopeFilterOwner';
import testOrgScopeFilterOwnerError from 'lib/services/auth/tests/utils/testOrgScopeFilterOwnerError';
import testOwnerScopeFilterError from 'lib/services/auth/tests/utils/testOwnerScopeFilterError';
import testSiteAdminScopeFilterError from 'lib/services/auth/tests/utils/testSiteAdminScopeFilterError';
import testClientBasicScopeFilter from 'lib/services/auth/tests/utils/testClientBasicScopeFilter';
import testClientBasicScopeFilterError from 'lib/services/auth/tests/utils/testClientBasicScopeFilterError';
...
describe('model scope filters statement', () => {
  ...
  testOrgScopeFilter(modelName, 'view', [SITE_ADMIN], TEST_ORG_STATEMENT_FILTER);
  ...
  testOrgScopeFilter(modelName, 'view', [MANAGE_ALL_USERS], TEST_ORG_STATEMENT_FILTER);
...
describe('client token model scope filters statement', () => {
  setup();
  testClientBasicScopeFilter(modelName, 'view', [ALL], TEST_ORG_FILTER);
  testClientBasicScopeFilter(modelName, 'edit', [XAPI_ALL], TEST_ORG_FILTER);
  testClientBasicScopeFilter(modelName, 'edit', [XAPI_STATEMENTS_WRITE], TEST_ORG_FILTER);
  testClientBasicScopeFilter(modelName, 'delete', [XAPI_STATEMENTS_DELETE], TEST_ORG_FILTER);

  testClientBasicScopeFilterError(modelName, 'edit', []);
  testClientBasicScopeFilterError(modelName, 'edit', [ALL]);
  testClientBasicScopeFilterError(modelName, 'delete', []);
  testClientBasicScopeFilterError(modelName, 'delete', [ALL]);
  testClientBasicScopeFilterError(modelName, 'delete', [SITE_ADMIN]);
});
