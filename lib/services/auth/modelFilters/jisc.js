import { TRIBAL_INSIGHT, LAP, SSP, STUDENT_APP, OPENDASH } from 'lib/constants/scopes';
...
export default async (opts) => {
  switch (opts.modelName.toLowerCase()) {
    ...
    case 'studentmoduleinstance':
      return getJiscModelFilter([STUDENT_APP, TRIBAL_INSIGHT, LAP, SSP, OPENDASH])(opts);
    case 'module':
    case 'moduleinstance':
      return getJiscModelFilter([TRIBAL_INSIGHT, LAP, SSP, OPENDASH])(opts);
    case 'modulevlemap':
      return getJiscModelFilter([STUDENT_APP, TRIBAL_INSIGHT, LAP, OPENDASH])(opts);
    case 'staff':
