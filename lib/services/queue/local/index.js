...
export const subscribe = ({ queueName, handler, onProcessed = () => {} }, done = () => {}) => {
  ...
  const newSubscribersList = subscribersList.push(handlerWithProcessed);
