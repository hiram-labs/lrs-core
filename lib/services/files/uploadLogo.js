import fs from 'fs';
import { LOGO_ALLOWED_FILE_TYPES, LOGO_ALLOWED_FILE_EXT } from 'lib/constants/uploads';
...
const checkLogoFile = checkFileType(LOGO_ALLOWED_FILE_TYPES)(LOGO_ALLOWED_FILE_EXT);
