...
const result1 = [
...

  {
    ...
    value: { id: shortObject.id },
    fullValue: shortObject,
    display: shortObject.definition.name
  },
  {
    path: ['statement', 'object', 'definition', 'type'],
    value: object.definition.type,
    fullValue: object.definition.type,
    display: null
  },

  {
    path: ['statement', 'object', 'definition', 'extensions', 'http://extensions&46;key1'],
    value: extensions['http://extensions&46;key1'],
    fullValue: extensions['http://extensions&46;key1'],
    display: null
  },
  {
    path: ['statement', 'object', 'definition', 'extensions', 'http://extensions&46;key2', 'foo'],
    value: extensions['http://extensions&46;key2'].foo,
    fullValue: extensions['http://extensions&46;key2'].foo,
    display: null
  },
  {
    path: ['statement', 'object', 'definition', 'extensions', 'http://extensions&46;key3'],
    value: extensions['http://extensions&46;key3'][0],
    fullValue: extensions['http://extensions&46;key3'][0],
    display: null
  },
  {
    path: ['statement', 'object', 'definition', 'extensions', 'http://extensions&46;key3'],
    value: extensions['http://extensions&46;key3'][1],
    fullValue: extensions['http://extensions&46;key3'][1],
    display: null
  },
  {
    path: ['statement', 'object', 'definition', 'extensions', 'http://extensions&46;key3'],
    value: extensions['http://extensions&46;key3'][2],
    fullValue: extensions['http://extensions&46;key3'][2],
    display: null
  },
  ...
  {
    path: ['statement', 'context', 'team'],
    value: { objectType: group.objectType, member: group.member },
    fullValue: group,
    display: group.name
  },
  { path: ['statement', 'context', 'revision'], value: 'v1.0.0', fullValue: 'v1.0.0', display: null },
  {
    path: ['statement', 'context', 'platform'],
    value: 'Example Platform',
    fullValue: 'Example Platform',
    display: null
  },
  ...
  {
    path: ['statement', 'context', 'contextActivities', 'category'],
    value: { id: shortObject2.id },
    fullValue: shortObject2,
    display: shortObject2.definition.name
  },
  {
    path: ['statement', 'context', 'contextActivities', 'category', 'definition', 'type'],
    value: object.definition.type,
    fullValue: object.definition.type,
    display: null
  },
  {
    path: ['statement', 'context', 'contextActivities', 'category', 'definition', 'type'],
    value: object.definition.type,
    fullValue: object2.definition.type,
    display: null
  },
  {
    path: ['statement', 'context', 'contextActivities', 'grouping'],
    value: { id: shortObject.id },
    fullValue: shortObject,
    display: shortObject.definition.name
  },
  {
    path: ['statement', 'context', 'contextActivities', 'grouping', 'definition', 'type'],
    value: object.definition.type,
    fullValue: object.definition.type,
    display: null
  },
  {
    path: ['statement', 'context', 'contextActivities', 'parent'],
    value: { id: shortObject2.id },
    fullValue: shortObject2,
    display: shortObject2.definition.name
  },
  ...
  {
    path: ['statement', 'context', 'extensions', 'http://extensions&46;key1'],
    value: extensions['http://extensions&46;key1'],
    fullValue: extensions['http://extensions&46;key1'],
    display: null
  },
  {
    path: ['statement', 'context', 'extensions', 'http://extensions&46;key2', 'foo'],
    value: extensions['http://extensions&46;key2'].foo,
    fullValue: extensions['http://extensions&46;key2'].foo,
    display: null
  },
  {
    path: ['statement', 'context', 'extensions', 'http://extensions&46;key3'],
    value: extensions['http://extensions&46;key3'][0],
    fullValue: extensions['http://extensions&46;key3'][0],
    display: null
  },
  ...
  {
    path: ['statement', 'result', 'extensions', 'http://extensions&46;key1'],
    value: extensions['http://extensions&46;key1'],
    fullValue: extensions['http://extensions&46;key1'],
    display: null
  },
  {
    path: ['statement', 'result', 'extensions', 'http://extensions&46;key2', 'foo'],
    value: extensions['http://extensions&46;key2'].foo,
    fullValue: extensions['http://extensions&46;key2'].foo,
    display: null
  },
  {
    path: ['statement', 'result', 'extensions', 'http://extensions&46;key3'],
    value: extensions['http://extensions&46;key3'][0],
    fullValue: extensions['http://extensions&46;key3'][0],
    display: null
  },
  ...
  {
    path: ['metadata', 'http://learninglocker&46;net/net/test', 'v1', 'foo'],
    value: 'bar',
    fullValue: 'bar',
    display: null
  }
        ...
        Statement.create(
          {
            ...
            metadata: {
              'http://learninglocker&46;net/net/test': {
                v1: {
                  foo: 'bar'
                }
              }
