export const PERSONA_ALLOWED_FILE_TYPES = ['text/csv', 'application/csv', 'application/vnd.ms-excel'];
export const PERSONA_ALLOWED_FILE_EXT = ['.csv'];

export const LOGO_ALLOWED_FILE_TYPES = ['image/png', 'image/jpg', 'image/jpeg', 'image/bmp'];
