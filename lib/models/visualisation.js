...
const getVisualisationIdsFromAuth = (authInfo) => authInfo.token.extensions.visualisationIds;
...
const Visualisation = getConnection().model('Visualisation', schema, 'visualisations');
