  ...
  configuration: {
    ...
    url: {
      ...
      required: function urlRequired() {
        ...
        return immutableSchema.get('active', false) && true;
      },
      type: String
    },
    authType: {
    ...
    secret: {
      ...
      required: function seceretRequired() {
        const immutableSchema = fromJS(this.toObject());
        return (
          immutableSchema.get('active', false) &&
...
const StatementForwarding = getConnection().model('StatementForwarding', schema, 'statementForwarding');
