...
describe('helpers/update$dteTimezoneInDB', () => {
  ...
  beforeEach(async () => {
    ...
    user = await User.create({
      email: `${organisation._id.toString()}@v360energy.com`,
    ...
    user2 = await User.create({
      email: `${organisation2._id.toString()}@v360energy.com`,
  ...
  afterEach(async () => {
    await Promise.all([
      ...
      organisation2.deleteOne(),
      dashboard.deleteOne(),
      statementForwarding.deleteOne(),
      statementForwarding2.deleteOne(),
      user.deleteOne(),
      user2.deleteOne(),
      visualisation.deleteOne(),
      visualisation2.deleteOne()
    ]);
  });
  ...
  it('should update $dte timezone offset', async () => {
    ...
    expect(updatedDashboardShareableFilter.getIn(['$and', 0, 'timestamp', '$lt', '$dte'])).to.equal(
      '2019-04-17T00:00+09:00'
    );
    expect(updatedDashboardShareableFilter.getIn(['$and', 1, 'stored', '$gt', '$dte'])).to.equal(
      '2018-11-30T04:00+09:00'
    );
    ...
    expect(updatedStatementForwardingQuery.getIn(['$and', 0, 'timestamp', '$lt', '$dte'])).to.equal(
      '2019-04-17T00:00+09:00'
    );
    expect(updatedStatementForwardingQuery.getIn(['$and', 1, 'stored', '$gt', '$dte'])).to.equal(
      '2018-11-30T04:00+09:00'
    );
    ...
    expect(updatedUserOrganisationSettingsFilter.getIn(['$and', 0, 'timestamp', '$lt', '$dte'])).to.equal(
      '2019-04-17T00:00+09:00'
    );
    expect(updatedUserOrganisationSettingsFilter.getIn(['$and', 1, 'stored', '$gt', '$dte'])).to.equal(
      '2018-11-30T04:00+09:00'
    );
    ...
    expect(updatedVisualisationFilter0.getIn(['$and', 0, 'timestamp', '$lt', '$dte'])).to.equal(
      '2019-04-17T00:00+09:00'
    );
    expect(updatedVisualisationFilter1.getIn(['$and', 0, 'timestamp', '$lt', '$dte'])).to.equal(
      '2019-04-17T00:00+09:00'
    );
    expect(updatedVisualisationAxesxQuery.getIn(['$and', 0, 'timestamp', '$lt', '$dte'])).to.equal(
      '2019-04-17T00:00+09:00'
    );
    expect(updatedVisualisationAxesyQuery.getIn(['$and', 0, 'timestamp', '$lt', '$dte'])).to.equal(
      '2019-04-17T00:00+09:00'
    );
    ...
    expect(updatedVisualisationAxesxQuery.getIn(['$and', 1, 'stored', '$gt', '$dte'])).to.equal(
      '2018-11-30T04:00+09:00'
    );
    expect(updatedVisualisationAxesyQuery.getIn(['$and', 1, 'stored', '$gt', '$dte'])).to.equal(
      '2018-11-30T04:00+09:00'
    );
  });
  ...
  it('should not update $dte timezone offset if the object has own timezone', async () => {
    ...
    expect(updatedDashboardShareableFilter.getIn(['$and', 0, 'timestamp', '$lt', '$dte'])).to.equal(
      '2019-04-17T00:00-08:00'
    );
    expect(updatedDashboardShareableFilter.getIn(['$and', 1, 'stored', '$gt', '$dte'])).to.equal(
      '2018-11-30T04:00+03:00'
    );
  ...
  it('should not update $dte timezone offset of other than target organisation', async () => {
    ...
    expect(updatedStatementForwarding2Query.getIn(['$and', 0, 'timestamp', '$lt', '$dte'])).to.equal(
      '2019-04-17T00:00-08:00'
    );
    expect(updatedStatementForwarding2Query.getIn(['$and', 1, 'stored', '$gt', '$dte'])).to.equal(
      '2018-11-30T04:00+03:00'
    );
    ...
    expect(updatedUserOrganisationSettings2Filter.getIn(['$and', 0, 'timestamp', '$lt', '$dte'])).to.equal(
      '2019-04-17T00:00-08:00'
    );
    expect(updatedUserOrganisationSettings2Filter.getIn(['$and', 1, 'stored', '$gt', '$dte'])).to.equal(
      '2018-11-30T04:00+03:00'
    );
  });
