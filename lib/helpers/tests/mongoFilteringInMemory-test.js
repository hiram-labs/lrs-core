...
describe('mongoFilteringInMemory', () => {
  it('should match statement', () => {
    ...
    expect(mongoFilteringInMemory(query)(testStatement)).to.equal(true);
  });
  ...
  it('should not match', () => {
    ...
    expect(mongoFilteringInMemory(query)(testStatement)).to.equal(false);
  });

  it('should match empty filter', () => {
    expect(mongoFilteringInMemory({})(testStatement)).to.equal(true);
  });
});
