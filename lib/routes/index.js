...
const routes = [
  ...
  { name: 'organisation.data.dashboards.add', path: '/add' },
  ...
  { name: 'organisation.settings.apps', path: '/apps' },

  // Apps
  { name: 'organisation.apps', path: '/apps' },
  { name: 'organisation.apps.salesDemo', path: '/salesDemo' },

  // Embedded dashboards
  { name: 'embedded-dashboard', path: '/dashboards/:dashboardId' },
  { name: 'embedded-dashboard.shareable', path: '/:shareableId/*splat' },
  { name: 'embedded-dashboard.shareable.filter', path: '?:filter' }
];
