      ...
      const input = JSON.stringify({
        $match: {
          $and: [
            {
              $comment: comment1,
              $or: [{ 'key.a': 'value1' }, { 'key.a': 'value2' }, { 'key.a': 'value3' }]
            },
            {
              $comment: comment2,
              $nor: [{ 'key.b': { k: 'value5' } }, { 'key.b': { k: 'value6' } }]
            },
            {
              $comment: comment3,
              'key.c': true
          ...
          $and: [
            {
              ...
              $or: [{ 'key.a': 'value1' }, { 'key.a': 'value2', 'key.c': 'value3' }, { 'key.a': 'value4' }]
            },
            {
              $comment: normalComment,
              $nor: [{ 'key.b': 'value5' }, { 'key.b': 'value6' }]
            },
            {
              $comment: personaImportComment,
              $nor: [{ 'key.c': 'value7' }, { 'key.c': 'value8' }]
            }
          ]
        }
      });
