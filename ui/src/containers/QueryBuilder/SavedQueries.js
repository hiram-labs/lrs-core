...
const getConditions = (query) => {
  ...
  return Iterable.isIterable(conditions) ? conditions : fromJS(conditions);
};
...
const SavedQueries = ({ selectedQuery, query, updateSelectedQuery, applySelectedQuery, setSelectedQuery }) => {
