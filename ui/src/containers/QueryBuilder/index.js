...
class QueryBuilder extends Component {
  ...
  renderBuilder = () => {
    ...
    return isRawMode ? (
      <RawQueryBuilder onQueryChange={this.onQueryChange} query={this.props.query} />
    ) : (
      <BasicQueryBuilder
  ...
  renderButtons = ({ isRawMode }) => (
    <ButtonBox>
      <button className="btn btn-default btn-xs" onClick={this.refreshStatements} title="Refresh statements">
        <i className="ion-refresh" />
      </button>
      <button className="btn btn-default btn-xs" onClick={this.clearQuery} title="Clear query">
        <i className="ion-close-round" />
      </button>
      <button className="btn btn-default btn-xs" onClick={this.toggleRaw} title="Toggle edit mode">
