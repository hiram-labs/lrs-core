...
const getTotalCount = ({ progressModel, workerStatus, model }) => {
...
const getProcessedCount = ({ progressModel, workerStatus, model, totalCount }) => {
...
export default ({ model, schema }) => {
  ...
  return <ProgressBar type="linear" mode="determinate" value={processedCount} max={totalCount} />;
};
