...
export class ModelListItem extends Component {
  ...
  render = () => {
    ...
    return (
      <Wrapper isExpanded={isExpanded} className={'panel panel-default'} style={style}>
        <div className={headerClasses} onClick={this.expandItem}>
          ...
          <BuilderDescription title={getIdentifier(model)}>{getDescription(model)}</BuilderDescription>
          {displayOwner && (
