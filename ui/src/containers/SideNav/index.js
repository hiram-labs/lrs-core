...
class SideNav extends Component {
  ...
  renderLink = (activeClass, routeName, text) => {
    ...
    return (
      <li>
        <Link routeName={routeName} routeParams={{ organisationId }} activeClassName={activeClass}>
          {text}
        </Link>
      </li>
    );
  ...
  renderSettings = () => {
    ...
    const canViewSettings = canViewStores || canViewUsers || canViewOrganisations || canViewClients || canViewRoles;
        ...
        <SideNavInner>
          <SideNavHeader>
            ...
            <div className="media-body">
              <div style={{ textAlign: 'center' }}>{model.get('name')}</div>
            </div>
          </SideNavHeader>
