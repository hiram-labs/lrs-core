...
export class ScatterAxesEditor extends BaseAxesEditor {
  ...
  getAxisDefault = (axis, model) => {
    ...
    const defaultLabel =
      axis === 'x'
        ? model.getIn(['axesxValue', 'searchString'], 'X-Axis')
        : model.getIn(['axesyValue', 'searchString'], 'Y-Axis');
  ...
  render = () => (
    <div>
      <div className="form-group">
        ...
        <GroupEditor group={this.getAxesValue('group')} changeGroup={this.changeAxes.bind(this, 'group')} />
      </div>
