 ...
 */
const VisualisationViewer = ({ model }) => {
  ...
  switch (type) {
    ...
    case TEMPLATE_STREAM_INTERACTIONS_VS_ENGAGEMENT:
      return (
        <TemplateStreamInteractionsVsEngagement visualisationId={visualisationId} showSourceView={showSourceView} />
      );
    ...
    case TEMPLATE_STREAM_LEARNER_INTERACTIONS_BY_DATE_AND_VERB:
      return (
        <TemplateStreamLearnerInteractionsByDateAndVerb
    ...
    case TEMPLATE_STREAM_USER_ENGAGEMENT_LEADERBOARD:
      return (
        <TemplateStreamUserEngagementLeaderboard visualisationId={visualisationId} showSourceView={showSourceView} />
      );
    case TEMPLATE_STREAM_PROPORTION_OF_SOCIAL_INTERACTIONS:
      return (
        <TemplateStreamProportionOfSocialInteractions
          visualisationId={visualisationId}
          showSourceView={showSourceView}
        />
      );
    case TEMPLATE_STREAM_ACTIVITIES_WITH_MOST_COMMENTS:
      return (
        <TemplateStreamActivitiesWithMostComments visualisationId={visualisationId} showSourceView={showSourceView} />
      );
 ...
 */
export default compose(withProps({ schema: 'visualisation' }), withModel)(VisualisationViewer);
