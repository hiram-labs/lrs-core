 ...
 */
const FilterForm = ({ visualisationId, index, filter, canEditLabel, timezone, orgTimezone, onChange, onDelete }) => {
    ...
    <div>
      {canEditLabel && (
        <div className="form-group">
          ...
          <span onClick={onDelete} title="Delete" className="btn-sm btn pull-right">
