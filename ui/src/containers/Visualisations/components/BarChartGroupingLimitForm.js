 ...
 */
const BarChartGroupingLimit = ({ barChartGroupingLimit, onChange }) => (
  <div className="form-group">
    <select className="options-menu" value={barChartGroupingLimit} onChange={(e) => onChange(parseInt(e.target.value))}>
