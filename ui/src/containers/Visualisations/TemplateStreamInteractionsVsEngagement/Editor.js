 ...
 */
const Editor = ({ model, orgTimezone, updateModel }) => {
  ...
  const onChangeTrendLines = useCallback(
    (checked) => {
      updateModel({
        schema: 'visualisation',
        id,
        ...
        <div>
          ...
          <Tabs index={tabIndex} onChange={setTabIndex}>
            ...
            <Tab key="options" label="Options">
              ...
              {!model.get('sourceView') && (
                <TrendLinesSwitch showTrendLines={model.get('trendLines')} onChange={onChangeTrendLines} />
              )}
