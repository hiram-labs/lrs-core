...
export default class Criteria extends Component {
  ...
  renderEmptyCriteria = () => {
    ...
    return <Criterion section={this.props.section} criterion={criterion} onCriterionChange={this.createCriterion} />;
  };

  render = () => (
    <div>
      {this.props.criteria.count() > 0 ? this.renderCriteria() : this.renderEmptyCriteria()}
      {
