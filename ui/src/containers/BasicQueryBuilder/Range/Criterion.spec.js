...
describe('BasicQueryBuilder -> Range Criterion', () => {
  test('render', () => {
    ...
    const criterion = renderer.create(<Criterion section={section} />).toJSON();
  ...
  test('with value', () => {
    ...
    const criterion = renderer.create(<Criterion criterion={mockCriteria} section={section} />).toJSON();
