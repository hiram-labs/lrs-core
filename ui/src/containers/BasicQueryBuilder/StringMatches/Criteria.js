...
export default class Criteria extends Component {
  ...
  renderCriteria = () => <div>{this.props.criteria.map(this.renderCriterion.bind(this)).first()}</div>;

  renderEmptyCriteria = () => (
    <div>
      <Criterion section={this.props.section} criterion={new Map()} onCriterionChange={this.createCriterion} />
    </div>
  );
