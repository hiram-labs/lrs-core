...
export class Criterion extends Component {
  ...
  shouldComponentUpdate = ({ section, criterion }) =>
    !(this.props.section.equals(section) && this.props.criterion.equals(criterion));
    ...
    return (
      <CriterionWrapper>
        <CriterionValue isFullWidth={!canDeleteCriterion}>
          <div>
            <RadioLabel htmlFor={trueId}>True:&nbsp;&nbsp;</RadioLabel>
            <input
              id={trueId}
              type="radio"
              name={inputName}
          ...
          <div>
            <RadioLabel htmlFor={falseId}>False:&nbsp;&nbsp;</RadioLabel>
            <input
              id={falseId}
              type="radio"
              name={inputName}
