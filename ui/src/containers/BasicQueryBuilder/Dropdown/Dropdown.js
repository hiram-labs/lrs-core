...
class Dropdown extends Component {
  ...
  shouldComponentUpdate = (nextProps, nextState) =>
    !(this.props.children.equals(nextProps.children) && this.state.highlighted === nextState.highlighted);
  ...
  highlightNextChild = () => {
    ...
    if (this.state.highlighted === null) {
      ...
      nextKeys = keys.skipUntil(this.equalsHighlighted).skipWhile(this.equalsHighlighted);
    }
