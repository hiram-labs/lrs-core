...
const renderOptions =
  (onSelectOption, filter, selectOptionBlur) =>
  ({ onBlur }) => (
    <CacheKeysOptionList
...
export const render = ({ setFilter, filter, onSelectOption, value, onChange, selectOptionBlur }) => (
  <AutoComplete2
...
export default compose(withFilter, withSelectOptionBlur)(render);
