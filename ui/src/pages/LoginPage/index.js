 ...
 * @returns {*}
 */
const render = ({ oAuthLoginStart, loginStart, loginRequestState, loginError, googleAuth }) => {
  let emailInput;
  let passwordInput;
          ...
          {!inProgress && (
            <div>
              <div style={{ marginTop: 20, textAlign: 'center' }}>
                <button style={{ margin: '0 5px' }} type="submit" className="btn btn-primary" onClick={onClickLogin}>
                  <i className="ion-log-in" /> Login
                </button>
                {googleAuthEnabled && (
                  <button style={{ margin: '0 5px' }} onClick={onClickOAuthLogin} className="btn btn-primary">
