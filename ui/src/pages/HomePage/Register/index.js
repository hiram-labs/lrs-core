                ...
                <form onSubmit={onSubmit}>
                  ...
                  <div className="modal-footer">
                    <div className="col-xs-12 clearfix">
                      <button className="btn btn-primary btn-sm pull-right">Confirm</button>
                    </div>
                  </div>
                </form>
              </div>
          ...
          <CardContainer>
            <div>
              ...
              <RegistrationInfoText>
                ...
                <br />
                <p>
                  Learning Locker Data Cloud is our fully managed option for Learning Locker, including a range of
                  feature enhancing plugins only available to paying customers.
                </p>
                <ul>
                  <li>
                    <p>Fully managed, auto-scaling, single tenant hosting in a range of AWS data locations</p>
                  </li>
                  <li>
                    <p>World-class customer support, on the phone and online</p>
                  </li>
                  <li>
                    <p>Secure to ISO 27001 certification standards</p>
                  </li>
                  <li>
                    <p>Plug and play integrations with platforms such as Degreed, Cornerstone and Credly</p>
                  </li>
                  <li>
                    <p>Data lake and BI integrations such as Tableau, SiSense and Power BI</p>
                  </li>
                </ul>
                <p>
                  Unique plugin features including journeys, GDPR request management, semantic analysis, and statement
                  forwarding.
                </p>
              </RegistrationInfoText>
        ...
        <Card>
          <CardContainer>
            <div>
              ...
              <RegistrationInfoText>
                <p>
                  By registering, you help the Learning Locker team understand more about who is adopting xAPI, how
                  Learning Locker is being used and gives us a feedback channel to reach out for input on our next
              ...
              <NotNowText className="pull-left" onClick={setProceedOnce}>
                Not now
              </NotNowText>
            </div>
          </CardContainer>
