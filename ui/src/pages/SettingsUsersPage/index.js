  ...
  renderUserDescription = (model) => {
    ...
    return (
      <span>
        ...
        {name}
        {model.has('googleId') && (
          <i className="ion ion-social-googleplus" style={{ marginLeft: '1em', fontWeight: 'bold' }} />
        )}
      </span>
    );
  };
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header modal-header-bg">
                  <button type="button" className="close" aria-label="Close" onClick={this.onClickCloseModal}>
...
export default connect((state) => ({ searchString: modelQueryStringSelector(schema)(state) }), { addModel })(Users);
