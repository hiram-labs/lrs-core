...
const enhance = compose(withProps({ schema: 'personaIdentifier' }), withModel);
...
const render = ({ model, deleteModel, getMetadata, setMetadata }) => {
  ...
  return (
    <tr>
      <TableData>{identifierTypeDisplays[identifierType]}</TableData>
      <TableData>
      ...
      <ActionsTableData>
        {isReassignmentVisible ? (
          ...
          <div>
            <IconButton title="Reassign identifier" icon="icon ion-person-stalker" onClick={handleShowReassignment} />
