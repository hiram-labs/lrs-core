...
const render = ({ personaId, models, isNewAttributeVisible, changeNewAttributeVisibility, addModel }) => {
  ...
  return (
    <div>
      ...
      <table style={{ width: '100%' }}>
        ...
        <tbody>
          {!isNewAttributeVisible ? null : <NewRow onAdd={handleNewRowAdd} onCancel={handleNewRowCancel} />}
