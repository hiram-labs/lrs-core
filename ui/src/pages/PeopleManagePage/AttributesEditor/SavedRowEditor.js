...
const render = ({ model, setMetadata, attributeValue, setAttributeValue, saveModel }) => {
  ...
  return (
    <tr>
      ...
      <TableData>
        <TypedInput value={attributeValue} placeholder="value" onChange={setAttributeValue} onSubmit={handleSave} />
      </TableData>
      <TableActionsData>
