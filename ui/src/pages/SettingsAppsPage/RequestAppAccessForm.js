...
import { requestAppAccess, requestStateSelector } from 'ui/redux/modules/requestAppAccess';
  ...
  const privacyPolicyLabel = (
    <div>
      *I consent to storage of my data according to the{' '}
      <a href="https://www.ht2labs.com/privacy-policy/" target="blank">
        Privacy Policy
      </a>
    </div>
  );
    ...
    <div>
      <div className="panel panel-default">
        <div className="panel-heading">
          <div className="panel-title">Get in touch to find out how to access this app</div>
        </div>
        <div className="box">
