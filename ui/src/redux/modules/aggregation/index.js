...
export const aggregationResultsSelector = (pipeline) =>
  createSelector(aggregationSelector, (aggregations) => aggregations.getIn([pipeline, 'result']));

export const aggregationHasResultSelector = (pipeline) =>
  createSelector(aggregationSelector, (aggregations) =>
    OrderedMap.isOrderedMap(aggregations.getIn([pipeline, 'result']))
  );
