...
export const queriesSelectedIdSelector = (keyPath) =>
  createSelector([queriesSelector], (queryState) => queryState.getIn([keyPath, 'selectedId'], 'selectedId'));
export const queriesSelectedModelSelector = (keyPath) =>
  createSelector([(state) => state, queriesSelectedIdSelector(keyPath)], (state, queryId) =>
    modelsSchemaIdSelector('query', queryId)(state)
  );
export const queriesSectionsSelector = (keyPath) =>
  createSelector([queriesSelector], (queryState) => queryState.getIn(keyPath.push('sections'), initialSections));
