...
export const UPDATE_MODEL = 'learninglocker/models/learninglocker/models/UPDATE_MODEL';
export const UPDATE_MODEL_ERRORS = 'learninglocker/models/learninglocker/models/UPDATE_MODEL_ERRORS';
export const MAKE_PENDING = 'learninglocker/models/learninglocker/models/MAKE_PENDING';
export const CLEAR_PENDING = 'learninglocker/models/learninglocker/models/CLEAR_PENDING';
...
const reduceClearPending = (state, { schema, id }) => state.deleteIn([schema, id, 'localCache', 'pending']);
 ...
 */
const requiresClearingModels = (schema, path) => schema === 'organisation' && isArray(path) && path[0] === 'timezone';
