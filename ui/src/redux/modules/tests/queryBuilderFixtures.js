...
export const resultCaches = fromJS({
  a: {
    ...
    values: ['My Learning Model Canvas', 'Confessions of a late registerer', 'Basic bar chart', 'Gate to week 2'],
    path: [
      'statement',
      'result',
      'extensions',
  ...
  d: {
    ...
    organisation: '56fbb868f1ec870140f0f9f8',
    values: [null],
    path: ['statement', 'result', 'extensions']
  },
  ...
  f: {
    ...
    path: ['statement', 'result', 'extensions', 'http://curatr3&46;com/define/extension/contribution-object', 'id']
  },

  g: {
    _id: '573b1a5101e7fb60be7a2dfd',
    organisation: '56fbb868f1ec870140f0f9f8',
    values: ['http://activitystrea.ms/schema/1.0/article'],
    path: [
      'statement',
      'result',
      'extensions',
