...
import { selectors as tokenSelectors, actions as tokenActions } from 'ui/redux/modules/auth/token';
...
const loginRequestStateSelector = createSelector([authSelector], (auth) => auth.get('orgLoginRequestState', false));
