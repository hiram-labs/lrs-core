...
export const requestStateSelector = () => createSelector(rootSelector, (state) => state.getIn(['requestState']));
...
const handler = handleActions({
  [REQUEST_APP_ACCESS]: (state) => state.setIn(['requestState'], IN_PROGRESS),
...
export const sagas = [requestAppAccessSaga];
