...
class OptionList extends Component {
  ...
  selectPrev = () => {
    this.setState((state, props) => {
      ...
      return {
        highlighted: !currentHighlighted ? this.props.options.size - 1 : currentHighlighted - 1
      };
    });
  };
  ...
  selectNext = () => {
    this.setState((state, props) => {
      const currentHighlighted = this.getHighLighted(props, state);
      return {
        highlighted: currentHighlighted === this.props.options.size - 1 ? 0 : currentHighlighted + 1
      };
    });
  };
  ...
  renderOptions = () => {
    ...
    return (
      <AutoSizer disableHeight>
        {({ width }) => (
          <InfiniteLoader isRowLoaded={this.isRowLoaded} loadMoreRows={this.props.fetchMore} rowCount={rowCount}>
