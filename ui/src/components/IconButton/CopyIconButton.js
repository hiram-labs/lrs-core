...
const CopyIconButton = ({ message, white, onClickConfirm, textFormat }) => {
  ...
  const className = white === true ? 'btn btn-default btn-sm flat-btn flat-white' : 'btn btn-sm btn-inverse';
  ...
  return textFormat ? (
    ...
    <button className={className} title="Copy" onClick={openModal} style={{ width: '33px' }}>
