...
export default class JsonTextArea extends Component {
  ...
  UNSAFE_componentWillReceiveProps = (nextProps) => {
    ...
    const selectionDifference = this.textarea._ref.selectionEnd - this.textarea._ref.selectionStart;
    ...
    const newState = assign({}, stateWithValue, stateWithCursor);
