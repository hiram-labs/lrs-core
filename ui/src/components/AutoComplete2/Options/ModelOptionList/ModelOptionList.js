...
const renderOption =
  ({ updateModel, deleteModel, parseOption, parseOptionTooltip, isEditing, canEdit, setIsEditing }) =>
  ({ option = new Map(), onSelectOption, deselectOption, resetRow, index, fields, defaultValues }) => {
...
const addProps = compose(
  ...
  withProps(
    ({
      ...
      children: isAddNewOptionEnabled ? (
        <AddNewOption
          fields={fields}
...
export default compose(withEditingState, addProps)(OptionList);
