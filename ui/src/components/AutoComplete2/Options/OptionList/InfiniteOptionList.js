...
import { AutoSizer, List as InfiniteList, InfiniteLoader, CellMeasurer, CellMeasurerCache } from 'react-virtualized';
...
const InfiniteOptionList = ({
  ...
  return (
    <AutoSizer disableHeight>
      {({ width }) => (
        <InfiniteLoader isRowLoaded={isRowLoaded({ options })} loadMoreRows={fetchMore} rowCount={rowCount}>
