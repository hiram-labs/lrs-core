    ...
    <div style={styles.picker}>
      ...
      <div style={styles.body}>
        <div style={styles.hue}>
          <Hue style={styles.Hue} hsl={props.hsl} pointer={ChromePointer} onChange={props.onChange} />
        </div>
        ...
        <div style={styles.palette}>
          {props.customColors
            ...
            .concat(dummySwatchList)
            .valueSeq()}
        </div>

        <div style={styles.checkMark}>
          <button className="btn btn-primary btn-sm" onClick={props.onClickCheckMark}>
