...
import { modelsSchemaIdSelector, isLoadingModelSelector } from 'ui/redux/selectors';
import { fetchModel, saveModel, updateModel, deleteModel, pollWhile } from 'ui/redux/actions';
import { getMetadataSelector, setInMetadata, deleteInMetadata } from 'ui/redux/modules/metadata';
...
export default (WrappedComponent) => {
  class WithModel extends Component {
    ...
    getMetadata = (key, defaultValue) => this.props.metadata.get(key, defaultValue);

    hasMetadata = (key) => this.props.metadata.has(key);
