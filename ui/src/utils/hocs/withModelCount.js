...
import { countSelector, shouldFetchCountSelector, isLoadingCountSelector } from 'ui/redux/selectors';
import { fetchModelsCount } from 'ui/redux/actions';
...
export default (WrappedComponent) => {
  class WithModelCount extends Component {
    ...
    fetchModelsCount = ({ schema, filter }) => this.props.fetchModelsCount({ schema, filter }).catch(() => {});
