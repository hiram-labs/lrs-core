...
import { getCachesFromStatement, saveCachePaths, saveCacheValues } from 'lib/services/querybuildercache';
import Promise from 'bluebird';

const promiseResolver = (cachePathsBatch, cacheValuesBatch, done) =>
  Promise.all([
...
export default wrapHandlerForStatement(STATEMENT_QUERYBUILDERCACHE_QUEUE, queryBuilderCacheStatementHandler);
