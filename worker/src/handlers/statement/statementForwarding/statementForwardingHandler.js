...
import { STATEMENT_FORWARDING_QUEUE, STATEMENT_FORWARDING_REQUEST_QUEUE } from 'lib/constants/statements';
...
export default wrapHandlerForStatement(STATEMENT_FORWARDING_QUEUE, (statement, done, { queue = Queue } = {}) =>
